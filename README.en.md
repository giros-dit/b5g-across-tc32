...
- **[Network control stack:](https://github.com/giros-dit/vnx-srv6/tree/365d3952625c8c89ee8b5d785ac5d1ca35e46895/NetworkControlStack/)** Performs route calculation based on data provided by the *ML stack*.
...
The experiments mainly use the topologies [redAcross6nodes](https://github.com/giros-dit/vnx-srv6/tree/365d3952625c8c89ee8b5d785ac5d1ca35e46895/clabernetes/redAcross6nodes/) and [redAcross10nodes](https://github.com/giros-dit/vnx-srv6/tree/365d3952625c8c89ee8b5d785ac5d1ca35e46895/clabernetes/redAcross10nodes/).
...
The execution of the [k8s-deploy-ml-models.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/16988bb9f2ba0509e802a3ecbce37e25c00de7b6/Kubernetes/k8s-deploy-ml-models.sh) script requires two input parameters to define the router type and model type that the Machine Learning Stack will use.
...
The [k8s-deploy-ml-dummy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/16988bb9f2ba0509e802a3ecbce37e25c00de7b6/Kubernetes/k8s-deploy-ml-dummy.sh) script does not require any input parameters.
...
To switch the ML Stack between ML models and dummy ML, you can use the [switch_ml_stack.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/16988bb9f2ba0509e802a3ecbce37e25c00de7b6/Kubernetes/scripts/ml_models/switch_ml_stack.sh) script as follows:
...
For more examples and detailed use cases, consult the [complete documentation](https://github.com/giros-dit/vnx-srv6/blob/365d3952625c8c89ee8b5d785ac5d1ca35e46895/NetworkControlStack/readme_networkinfo.md).
