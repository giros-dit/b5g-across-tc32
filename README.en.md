...
The Monitoring Stack deployment and service communication infrastructure is performed using the [k8s-deploy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/8650bdcd112fa8862142910579409468456837cd/Kubernetes/k8s-deploy.sh) script responsible for deploying:
