...
El script [k8s-deploy-ml-dummy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/d31863c4db54f8681e95b36e6664d47f5409856d/Kubernetes/k8s-deploy-ml-dummy.sh) no requiere ningún parámetro de entrada.
...
Para cambiar el ML Stack entre modelos ML y dummy ML, se puede utilizar el script [switch_ml_stack.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/d31863c4db54f8681e95b36e6664d47f5409856d/Kubernetes/scripts/ml_models/switch_ml_stack.sh) de la siguiente manera:
