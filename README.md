...
El script [k8s-deploy-ml-dummy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/b00563c5d15f79048a9a960e8dda8188070c9a69/Kubernetes/k8s-deploy-ml-dummy.sh) no requiere ningún parámetro de entrada.
...
Para cambiar el ML Stack entre modelos ML y dummy ML, se puede utilizar el script [switch_ml_stack.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/b00563c5d15f79048a9a960e8dda8188070c9a69/Kubernetes/scripts/ml_models/switch_ml_stack.sh) de la siguiente manera:
