...
- **[Network control stack:](https://github.com/giros-dit/vnx-srv6/tree/9e782f605ed93134edd7a095b1b466ae710fc9c4/NetworkControlStack/)** Realiza el cálculo de rutas en función de los datos proporcionados por el *ML stack*.
...
Los experimentos cursados emplean principalmente las topologías [redAcross6nodes](https://github.com/giros-dit/vnx-srv6/tree/9e782f605ed93134edd7a095b1b466ae710fc9c4/clabernetes/redAcross6nodes/) y [redAcross10nodes](https://github.com/giros-dit/vnx-srv6/tree/9e782f605ed93134edd7a095b1b466ae710fc9c4/clabernetes/redAcross10nodes/).

### Despliegue del *Monitoring stack* y Apache Kafka

El despliegue del *Monitoring Stack* y la infraestructura de comunicación entre servicios se realiza mediante el script [k8s-deploy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/973c0faa59ae973dece85808235b6e4182a451b9/Kubernetes/k8s-deploy.sh) encargado de desplegar:
...
Para cambiar el ML Stack entre modelos ML y dummy ML, se puede utilizar el script [switch_ml_stack.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/973c0faa59ae973dece85808235b6e4182a451b9/Kubernetes/scripts/ml_models/switch_ml_stack.sh) de la siguiente manera:
...
Para más ejemplos y casos de uso detallados, consulta la [documentación completa](https://github.com/giros-dit/vnx-srv6/blob/9e782f605ed93134edd7a095b1b466ae710fc9c4/NetworkControlStack/readme_networkinfo.md).
