...
- [k8s-deploy-ml-models.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/97fee73b18aa2fe6770721d2ecaaaa276291d146/Kubernetes/k8s-deploy-ml-models.sh): 
Despliega **Monitoring Stack**, **NDT Data Fabric** y **Machine Learning Stack** con ML models.
- [k8s-deploy-ml-dummy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/97fee73b18aa2fe6770721d2ecaaaa276291d146/Kubernetes/k8s-deploy-ml-dummy.sh): 
Despliega **Monitoring Stack**, **NDT Data Fabric** y **Machine Learning Stack** con ML dummy.

La ejecución del script [k8s-deploy-ml-models.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/97fee73b18aa2fe6770721d2ecaaaa276291d146/Kubernetes/k8s-deploy-ml-models.sh) requiere dos parámetros de entrada para definir el tipo de router y el tipo de modelo que utilizará la pila de Machine Learning, ML Stack.
...
El script [k8s-deploy-ml-dummy.sh](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/97fee73b18aa2fe6770721d2ecaaaa276291d146/Kubernetes/k8s-deploy-ml-dummy.sh) no requiere ningún parámetro de entrada.

## Experiment

Para definir un nuevo experimento a realizar, es necesario configurar los parámetros de definición de experimentos editando el fichero [config.json](https://github.com/giros-dit/ACROSS-monitoring-stack/tree/97fee73b18aa2fe6770721d2ecaaaa276291d146/Kubernetes/config/config.json) y reiniciar el microservicio Kafka Producer encargado de leer estos parámetros:
